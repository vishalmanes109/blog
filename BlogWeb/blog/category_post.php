...
<br>
  ...
  if(isset($_GET['post_category'])){
   ...
   while($rows=$result->fetch_assoc()){
     ...
     $description=substr($description,1,700);
...
<h3 class='mb-0' ></h3>
<br>
<div class='mb-1 text-muted' style='font-size:1em;' ><a href='#'> $categories</a> | $date | <a href='profile.php?author_name=$author'> $author</a></div><br>
...
<button   type='button' class='btn btn-primary' style='margin:2%;'>
   <span class='spinner-border spinner-border-sm'></span>
     <a style='color:white; text-decoration:none;' href='post.php?post_id=$post_id'> Read More.... </a>
</button>
